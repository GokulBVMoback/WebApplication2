<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Employee_reg.aspx.cs" Inherits="WebApplication2.Employee_reg" %>
                            ...
                            <div class="row">
                             ...
                             <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <asp:Button Text="Save" ID="btnsave" CssClass="btn btn-primary" Width="150px" runat="server" OnClick="btnsave_Click" />
                                </div>
                            </div>
